...
;;;###autoload
(defun +bl/get-project-root (&optional path)
  "Get the project root for PATH, defaulting to `default-directory'.
Tries projectile first if available, then falls back to project.el."
    ...
    (or
     ...
     (when-let ((project (project-current nil dir)))
       (if (fboundp 'project-root)
         ...
         ;; Older Emacs versions used project-roots
         (car (project-roots project))))
     ;; Return nil if no project found
     nil)))
